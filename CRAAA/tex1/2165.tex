...
\title{Síntesis poblacional de discos protoplanetarios: Comparación de modelos de disco y observaciones
}
...
\author{ J.L. Gomez\inst{1,2}, O.M. Guilera\inst{1,2}, M.M. Miller Bertolami\inst{1,2} \& M.P. Ronco\inst{1,2}
}
