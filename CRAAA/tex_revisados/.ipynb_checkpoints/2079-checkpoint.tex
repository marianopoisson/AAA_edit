...
\author{ A.~Hacker\inst{1}, R.~F.~Díaz\inst{1}, D.~J.~Armstrong\inst{2,3}, J.~Fern\'andez~Fern\'andez\inst{2,3}, S.~Müller\inst{4}, E.~Delgado-Mena\inst{5}, S.~G.~Sousa\inst{5}, V.~Adibekyan\inst{5,6}, K.~G.~Stassun\inst{7}, K.~A.~Collins\inst{8} \& S.~W.~Yee\inst{9,8}
%D. Bayliss$^{2}$,
%A.~Bieryla$^{8}$,
%F. Bouchy$^{10}$,
%R.~P.~Butler$^{11}$,
...
\keywords{planets and satellites: detection --- planets and satellites: general --- planets and satellites: gaseous planets --- planets and satellites: individual (TOI-2374, TIC 439366538 y TOI-3071, TIC 452006073)}
