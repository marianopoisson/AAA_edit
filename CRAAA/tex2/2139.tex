...
\title{Revisiting astrophysical bounds on continuous spontaneous localization models
}
...
\author{M.M Ocampo\inst{1,2}, M.M. Miller Bertolami\inst{1,2} \& G. León \inst{2}
}
...
\keywords{atomic processes --- planets and satellites: physical evolution --- white dwarfs
}
