...
\title{Aprendizaje autom\'atico en Auger Prime
}
...
\author{P. Sotomayor\inst{1} \& N. Gonzalez\inst{2,3}
}
...
Facultad de Ciencias Astron\'omicas y Geof{\'\i}sicas, UNLP, Argentina
\and
Instituto de Tecnolog\'ia en Detecci\'on y Astropart\'iculas, CONICET--UNSAM, Argentina
\and
...
\abstract{
Los rayos c\'osmicos, como las part\'iculas m\'as energ\'eticas del Universo, ofrecen informaci\'on valiosa sobre los mecanismos de aceleraci\'on en sus fuentes y los fondos de radiaci\'on c\'osmica en el espacio intergal\'actico. Este estudio se centra en el impacto de las t\'ecnicas de aprendizaje autom\'atico en la construcci\'on de un estimador estad\'istico del n\'umero de muones en las lluvias de part\'iculas secundarias generadas por los rayos c\'osmicos, en el contexto del Observatorio Pierre Auger y su actualizaci\'on, Auger Prime. Desarrollamos un modelo que mejora las estimaciones previas basadas en reglas fijas mediante t\'ecnicas de agrupamiento autom\'atico de lluvias y modelos de regresi\'on. Nuestros resultados proveen un estimador del n\'umero total de muones inyectados con un error relativo menor al 10\% respecto a la cantidad real en el 90\% de los lluvias evaluadas.
}
...
\keywords{methods: data analysis --- methods: statistical --- (ISM:) cosmic rays
}
...
\contact{pablosotomayor@fcaglp.unlp.edu.ar} 
