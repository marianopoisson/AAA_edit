...
\title{Supernova remnant radio spectra: 
A landmark catalogue for the astronomical community
}
...
\author{G. Castelletti\inst{1}, L. Sup\'an\inst{1}, N. Maza\inst{2} \& J. Bilos\inst{3}
}
...
\abstract{
Supernova remnants (SNRs) are natural synchrotron emitters in the radio band. This radiation is generated by electrons undergoing diffusive acceleration at the SNR shock front. Integrated and local spectral studies in radio provide valuable insights into the energy distribution of the accelerated particles that contribute to the leptonic component of Galactic cosmic rays, shock interactions with ambient matter, radio-gamma ray connections in the radiation of SNRs, and pulsar wind nebulae, among other phenomena. We are pleased to announce the forthcoming release of a new catalog featuring SNR radio continuum spectra, which will be freely available to the astronomical community. The value of this catalog lies in the inclusion of reliable measurements at lower frequencies (below 300 MHz) from emerging radio continuum surveys with new-generation instruments (e.g., LOFAR, LWA, MWA), along with a painstaking compilation of previously published flux densities across the entire radio band. By continuously incorporating new measurements from upcoming surveys, our catalog will provide to the community with a comprehensive and up-to-date valuable resource.
}
...
\contact{castelletti.g@gmail.com} 
