...
\title{Adaptaci\'on de la c\'amara CCD Sophia 2048B al espectr\'ografo REOSC del CASLEO
}
...
\abstract{
El espectrógrafo echelle REOSC es uno de los instrumentos más utilizados por los usuarios del telescopio Jorge Sahade. Durante mucho tiempo, se empleó junto con la cámara criogénica Tek1024 de la empresa Photometrics como su detector. Actualmente, el CASLEO cuenta con la nueva cámara CCD Sophia 2048-152-VS-X, refrigerada por efecto Peltier y adquirida a la empresa Teledyne Princeton Instruments. En este trabajo se describen las tareas de adaptación óptico-mecánica necesarias para integrar la cámara Sophia con el espectrógrafo REOSC, la implementación de un circulador de agua con etilenglicol para optimizar el enfriado del CCD, y el desarrollo de un software para automatizar la adquisición de imágenes de espectros de objetos astronómicos, lámparas de comparación, y otras calibraciones necesarias.  .
}
