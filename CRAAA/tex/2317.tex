...
\title{Sistema de sensado para estimar el seeing de la c\'upula del telescopio Jorge Sahade
}
...
\author{J.L. Aballay\inst{1}, P.F. Pereyra\inst{1}, O.A. Collado\inst{1}, M.A. Gim\'enez\inst{1}, B.G. Giuliani\inst{1} \& G.L. Fern\'andez\inst{1}
}
...
\abstract{
Uno de los principales objetivos de un observatorio astronómico es obtener imágenes de la mejor calidad posible. El factor que más contribuye a la distorsión de estas imágenes es el seeing, causado por la turbulencia atmosférica. A mediados de los años 70 se identificó otro factor significativo que también afecta la calidad de las imágenes, el seeing de cúpula (dome seeing). Este trabajo describe el conjunto de sensores térmicos instalados en el telescopio Jorge Sahade (JS) y la red de sensores térmicos inalámbricos que se están probando para su futura instalación en las zonas interna y externa de la cúpula. Se está implementando un sistema de adquisición en tiempo real que permitirá identificar las fuentes de transferencia de calor y el flujo de aire dentro del albergue del telescopio. Este sistema permitirá estimar el seeing de cúpula y determinar las medidas necesarias para reducirlo.
}
...
\keywords{instrumentation: miscellaneous --- methods: data analysis --- techniques: image processing --- telescopes
}
...
\contact{jaballay@casleo.gov.ar} 
