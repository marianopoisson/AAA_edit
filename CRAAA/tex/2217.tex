...
\title{Nuevos límites para la espectroscopia de campo integral
}
...
\author{R.A. Pignata\inst{1,3}, V.A. Cristiani \inst{2,3}, W. Weidmann\inst{1,3} \& D. Mast\inst{1,3}
}
...
\abstract{
La espectroscopia de campo integral, una tecnología introducida hace poco más de 30 años, ha transformado la astronomía. Sin embargo, sus beneficios son limitados cuando se combina con herramientas que no aprovechan todo su potencial. Por otro lado, aunque los diagramas de diagnóstico resultan valiosos para evaluar las condiciones físicas de las nebulosas planetarias, no se han adaptado a las nuevas capacidades de observación y análisis. Utilizamos datos IFS de MUSE y técnicas de clustering para explorar nuevos diagramas de diagnóstico que ayuden a llenar este vacío. El objetivo no es realizar un análisis spaxel por spaxel para comparar directamente estos resultados con los diagramas de diagnóstico existentes, sino examinar la distribución de conjuntos de spaxels que comparten propiedades comunes en un espacio de parámetros N-dimensional.
}
...
\keywords{techniques: spectroscopic --- methods: data analysis --- planetary nebulae: general
}
