...
\title{Where the stellar wind impinges the interstellar medium
}
...
\author{
M.C. Fernandez\inst{1}, D.H. Nickeler\inst{2}
}
...
Facultad de Ciencias Astron\'omicas y Geof{\'\i}sicas, UNLP, Argentina
\and
Astronomical Institute AV ČR Ondřejov, Czech Republic
}
...
\keywords{hydrodynamics --- stars: winds, outflows --- ISM: kinematics and dynamics
}
