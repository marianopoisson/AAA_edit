...
\title{Arqueología extragaláctica: reconstruyendo el pasado de una gigante
}
...
\abstract{
¿Cómo se formaron las galaxias y cuales son los principales procesos que intervinieron en su posterior evolución? Estas preguntas constituyen unos de los mayores desafíos de la astrofísica actual. Para responderlas se trabaja tanto desde el punto de vista teórico como observacional. En este último aspecto, uno de los caminos posibles es estudiar el mismo tipo  de objetos a diferentes corrimientos al rojo, y otro es analizar las propiedades actuales de las galaxias e intentar reconstruir su evolución. Ese es el esquema que se sigue en este trabajo: reunir la evidencia provista por diferentes trazadores y reconstruir la evolución pasada de las galaxias.  En tal contexto se presenta aquí  un análisis global de NGC 1316, una de las galaxias masivas del cúmulo de Fornax, reuniendo información de sus poblaciones estelares, medio interestelar (gas frío y gas ionizado), polvo, actividad nuclear y cúmulos estelares. Se incluye además información espacial y cinemática de varios de estos trazadores, logrando así una primera reconstrucción del proceso evolutivo de esta galaxia.
}
...
\keywords{galaxies: elliptical and lenticular, cD --- galaxies: formation --- galaxies: evolution
}
...
\contact{favio@fcaglp.unlp.edu.ar} 
