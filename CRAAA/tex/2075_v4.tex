...
\title{Modelo de la evolución del campo magnético fotosférico de regiones activas solares
}
...
\author{M. Poisson\inst{1}, C.D. Segundo Autor\inst{2} \& E.F. Tercer Autor\inst{1}
}
...
\contact{mpoisson@untref.edu.ar} 
