...
\title{Formaci\'on de galaxias lenticulares en la simulaci\'on TNG50
}
...
\author{E.O. Crisci\inst{1}, S.A. Cora\inst{1,2}, I.D. Gargiulo\inst{3}, A. Monachesi\inst{4} \& F.A. Gomez\inst{4}
}
...
Alix Partners
\and
Departamento de Astronom\'ia, Universidad de La Serena, La Serena, Chile
}
...
\abstract{
 Investigamos la formaci\'on de galaxias lenticulares utilizando la simulaci\'on de alta resoluci\'on TNG-50, parte de la colecci\'on de simulaciones cosmol\'ogicas hidrodin\'amicas Illustris-TNG. Partiendo de la hip\'otesis de que las galaxias lenticulares surgen principalmente de la transformaci\'on morfol\'ogica de galaxias disco espirales,
nos enfocamos en los distintos caminos evolutivos de las galaxias de disco con y sin estructura espiral a z = 0. Analizamos los eventos en sus historias evolutivas donde las galaxias lenticulares se desv\'ian de la evoluci\'on de las galaxias espirales. Estudiamos los canales de formaci\'on seg\'un su entorno (campo, grupos de galaxias, c\'umulos de galaxias) para cuantificar el impacto de los efectos ambientales, como la {\it ram pressure stripping} (presi\'on
de barrido), en la formaci\'on de galaxias lenticulares. En los casos donde experimentan fusiones, caracterizamos las fusiones involucradas en la formaci\'on de galaxias lenticulares, considerando las propiedades generales y orbitales de las galaxias sat\'elite involucradas.
}
...
\contact{elioc@fcaglp.unlp.edu.ar} 
