...
\title{Estimación de redshifts fotométricos en dirección al cúmulo de Fornax con S-PLUS + LePhare
}
...
\author{R.F. Haack\inst{1,2}, A.V. Smith Castelli\inst{1,2}, L. Sodré Jr.\inst{3}, \\ C. Mendes de Oliveira\inst{3} and A.R. Lopes\inst{2}
}
...
\and
Universidade de São Paulo, IAG, Brazil
}
...
\keywords{galaxies: clusters: Fornax -- techniques: photometric -- software: data analysis -- surveys
}
