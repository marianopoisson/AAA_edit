...
\title{Spectroscopy of the active nucleus of SDSS J092613.80+065056.4
}
...
\author{L. Vega Neme\inst{1,2} \& D. Ferreiro\inst{1,2}
}
...
\abstract{
We present detailed spectroscopy of SDSS J092613.80+065056.4 taken from Du Pont 2.5m Telescope at Las Campanas Observatory (Chile). The long-slit used of 0.7 arsec allowed us to extract spectra not only for the nucleu
s but also for regions mapped along the slit. We show the level of activity and the physical conditions, as well as the rotation curve of the object.
}
...
\keywords{Galaxies --- Active --- Nucleus
}
