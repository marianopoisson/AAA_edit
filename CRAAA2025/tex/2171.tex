...
\title{Irregularidades rotacionales en púlsares observados desde el IAR
}
...
\author{E. Zubieta\inst{1,2}, F. Garc\'{i}a\inst{1,2}, S. del Palacio\inst{1,3}, S.B. Araujo Furlan\inst{4,5}, G. Gancio\inst{1}, C.O. Lousto\inst{6,7}, J.A. Combi\inst{1,2}, C.M. Espinoza\inst{8,9}}
...
\institute{Instituto Argentino de Radioastronom\'ia (CCT La Plata, CONICET; CICPBA; UNLP),
         ...
         \and
             Instituto de Astronom\'\i{}a Teórica y Experimental, CONICET-UNC, Laprida 854, X5000BGR – Córdoba, Argentina
         \and
        ...
        \and Departamento de F\'isica, Universidad de Santiago de Chile (USACH),  Av. V\'ictor Jara 3493, Estaci\'on Central, Chile.
        \and Center for Interdisciplinary Research in Astrophysics and Space Sciences (CIRAS), Universidad de Santiago de Chile.
}
...
\abstract{Los púlsares tienen momentos de inercia muy altos, por lo cual presentan una rotación extremadamente estable. Sin embargo, esta estabilidad puede verse interrumpida por \textit{glitches} o \textit{timing noise}. Los \textit{glitches} consisten en un aumento repentino en la frecuencia de rotación del pulsar, y probablemente son causados por el desacoplamiento entre el interior superfluido de la estrella y la corteza sólida. Por otro lado, el \textit{timing noise} se manifiesta como un comportamiento suave y errante alrededor de una evolución rotacional simple, y su explicación sigue siendo un enigma. Aunque la distinción entre el \textit{timing noise} y los \textit{glitches} es evidente en términos de la discreción del evento, los \textit{glitches} más pequeños a menudo pueden confundirse con \textit{timing noise} y viceversa. Además, los \textit{glitches} pequeños también pueden confundirse con otras irregularidades rotacionales probablemente relacionadas a los cambios magnetosféricos del púlsar. Para poder distinguir entre los distintos tipos de fenómenos, es necesario tener un muestro de alta cadencia. Por lo tanto, en este trabajo desarrollamos un algoritmo para buscar pequeños eventos discretos en los púlsares observados desde el IAR para clasificarlos como \textit{glitches} pequeños o simples irregularidades.
}
...
\contact{ezubieta@iar.unlp.edu.ar} 
