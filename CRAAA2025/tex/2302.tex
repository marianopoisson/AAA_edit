...
\title{C\'alculo de Isocronas para el estudio de la\\ metalicidad del plano gal\'actico}
%\\
...
\author{C. Damia Rinc\'on\inst{1}, J.A. Panei\inst{1,2}, M.A. Corti\inst{1,3}}
...
El presente trabajo tiene como objetivo el c\'alculo de isocronas a partir de secuencias evolutivas en un amplio rango de masas y diferentes metalicidades para luego, tener una estimaci\'on de la metalicidad presente en el plano de la V\'ia L\'actea. Para ello, las isocronas son transformadas para el an\'alisis de datos fotom\'etricos de posibles miembros de c\'umulos abiertos del plano gal\'actico, obtenidos del Telescopio Espacial {\it Gaia}. Aqu\'i, presentaremos el resultado del trabajo efectuado en al menos un c\'umulo abierto de cada uno de los cuatro cuadrantes de la Galaxia, de los varios c\'umulos que ser\'an estudiados en un futuro pr\'oximo. Para ello y para tener un mayor conocimiento de los par\'ametros f\'isicos de las estrellas miembros, seleccionamos datos astrom\'etricos, fotom\'etricos y/o espectrosc\'opicos de los cat\'alogos {\it Gaia, 2MASS} y {\it LAMOST}. }
...
\keywords{(stars:) Hertzsprung-Russell and C-M diagrams --- catalogs --- (Galaxy:) open clusters and associations: general
}
...
\contact{camiladr@fcaglp.unlp.edu.ar} 
