...
\title{The recurrent and soon-to-be-even-more-famous nova T Coronae Borealis}
...
\institute{Universidad Nacional de Hurlingham, Secretaría de Investigación, Argentina \and
...
\abstract{
I imagine many of us have been approached in the past year with the question, "What about that nova the media claims will soon explode?" The nova in question, T Coronae Borealis (T~CrB), is a recurrent nova characterized by an approximately 80-year recurrence interval. While other recurrent novae are known, TCrB stands out because it exhibits precursor activity for nearly eight years leading up to its outburst. This activity is believed to facilitate the accumulation of the bulk of the mass needed to trigger the nova. Several hypotheses have been suggested to account for this phenomenon, and in this presentation, I will explore how the multiwavelength data (X-rays, optical, radio) collected over the past decade can substantiate a model where the precursor phase is attributed to an elevated accretion rate through the disk, similar to dwarf-novae eruptions.
}
