...
\title{Estudio químico del entorno de la región H\textsc{ii} ultracompacta G045.47+0.05
}
...
\author{M. Brook\inst{1,2}, M.E. Ortega\inst{1}, N.C. Martinez\inst{1,3}, N. Duronea\inst{4}, A. Petriella\inst{1} \& S. Paron\inst{1}
}
...
\abstract{
La región H\textsc{ii} ultracompacta G045.47+0.05, ubicada a una distancia de aproximadamente 8.5 kpc, presenta un maser clase II de CH$_3$OH e indicios de {\it outflows} moleculares que motivaron varios estudios multiespectrales a lo largo de los años. En su entorno se han observado varios núcleos moleculares, lo que sugiere que esta fuente es parte de la formación temprana de un posible cúmulo de estrellas OB. Más allá que existen varios trabajos hacia esta región, aún no fue realizado un estudio de la emisión de moléculas con alta resolución angular, lo cual es importante para comprender los procesos químicos que se activan una vez encendida una región H\textsc{ii}. En este trabajo, se presenta un adelanto de los resultados obtenidos del análisis   de datos extraídos del Atacama Large Millimeter Array (ALMA). Moléculas como SiO, HC$_{3}$N, CH$_3$OH, H$^{13}$CO$^{+}$, HN$^{13}$C, $^{12}$CO, C$^{17}$O, y varias moléculas sulfuradas, son analizadas en el contexto físico y químico de la región. Uno de los resultados obtenidos más interesantes es el descubrimiento de una estructura en forma de cáscara detectada en HC$_{3}$N rodeando a la región H\textsc{ii} ultracompacta; se discute su naturaleza.      
}
...
\contact{macarenabrook44@gmail.com} 
