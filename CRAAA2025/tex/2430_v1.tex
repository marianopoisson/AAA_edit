...
\title{Pipeline para caracterización de redes estelares, utilizando Kedro}
...
\author{M. G. Casatti \inst{1}, M. M. Marciszack \inst{1} \& C. Feinstein \inst{2,3}
}
...
\abstract{El trabajo expone los pasos necesarios para implementar un pipeline de procesamiento de datos utilizando el framework Kedro, destinado al preprocesamiento de datos astronómicos, a fin de realizar una 
caracterización de grupos estelares, tendientes a determinar si el set de datos objetivo conforma una red de mundo pequeño. Se detallan las características de la herramienta utilizada, así como los criterios analizados 
para su adopción, a la vez que los pasos de consulta y descarga de datos, definición de etapas de preprocesamiento, implementación de las mismas, ejecución y resultados finales. Asimismo se analizará en las 
conclusiones, el valor que estas herramientas aportan a la repetibilidad y confiabilidad, tanto de las etapas de preprocesamiento de información, como de la analítica de datos que con posterioridad se realiza 
sobre dicha información, tendiente a obtener flujos de análisis de datos confiables, repetibles y de alta calidad analítica.}
...
\contact{mcasatti@frc.utn.edu.ar} 
\begin{document}
\maketitle
\end{document}