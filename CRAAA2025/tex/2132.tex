...
\title{
A Python package for the characterization and comparison of cosmic voids
}
...
\author{Federico Bustillos\inst{1}, Sebastian Gualpa\inst{2}, \& E.F. Juan B. Cabral\inst{2}, Andres N. Ruiz\inst{2,3}, Bruno O. Sanchez\inst{4}, Dante J. Paz\inst{2,3}
}
...
\institute{
Universidad Nacional de Cordoba, X5000BGR Cordoba, Argentina
\and
