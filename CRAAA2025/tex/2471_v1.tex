...
\title{Physical properties of O Vz Stars in NGC 346}
...
\author{L. Arango\inst{1}, J.I. Arias\inst{1}, G. Holgado\inst{2}, G. Ferrero\inst{3,4}, C. Putkuri\inst{3} \& N.I. Morrell\inst{5}  
}
...
\institute{Universidad de La Serena, Departamento de Física y Astronomía,
              Av. Raúl Bitrán 1305, La Serena, Chile\\
              \email{johanna3193@gmail.com}     
         \and
...
\abstract{
O~Vz stars are defined by optical spectra where the He~\textsc{ii}~$\lambda4686$ absorption line is stronger than any other helium line, a feature traditionally interpreted as an indicator of lower luminosity, early evolutionary stage, and proximity to the zero-age main sequence (ZAMS).
To investigate their nature and the role of metallicity, we analyzed samples of O~V and O~Vz stars in two star-forming regions: NGC~346 (SMC) and 30~Doradus (LMC). For NGC~346, new classifications were made using spectra obtained with the Magellan Echellette spectrograph. In the case of 30~Doradus, archival data were reclassified using the same criteria to ensure consistency. Stellar parameters were derived via quantitative spectroscopic analysis.
Our results show that the fraction of O~Vz stars is similar in both environments despite their different metallicities. In NGC~346, O~Vz stars tend to have systematically lower projected rotational velocities and higher effective temperatures than their O~V counterparts, while surface gravities remain comparable. Their location on the HR diagram spans a range of evolutionary stages, suggesting that the defining Vz spectral feature may be more closely related to stellar wind properties than to proximity to the ZAMS alone.
...
\keywords{Stars: massive -- Stars: fundamental parameters -- Stars: Techniques: spectroscopic.
}
