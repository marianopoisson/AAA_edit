...
\title{Identifying Galaxies in the Unidentified Gamma-Ray Sources from the HAWC Catalog
}
...
\author{A. Pichel\inst{1}, L.D. Baravalle\inst{2} \& M.V. Alonso\inst{2}
}
...
\abstract{
The search for galaxies among unidentified gamma-ray sources presents a significant challenge in modern astrophysics. The High Altitude Water Cherenkov (HAWC) Experiment catalog, with its extensive list of unidentified gamma-ray sources, offers a unique opportunity to explore the extragalactic sky. This study aims to systematically identify potential galaxy candidates within this catalog, leveraging multi-wavelength observations and advanced data analysis techniques.
The search will incorporate data from infrared catalogs such as the VISTA Variables in the Vía Láctea (VVV) survey and the Wide-field Infrared Survey Explorer (WISE), as well as optical archiving data, providing critical insights into the nature of these gamma-ray sources.
}
...
\keywords{galaxies: active --- infrared: galaxies --- surveys --- catalogues
}
