...
chromospheric heights in the atmosphere. Despite the great information
this spectral range may bring to understand the chromosphere dynamics,
observations are scarse. In recent years solar telescopes coupled to
commercial uncooled but sensitive cameras with sensors for 10 µm wavelength
(30 THz) are producing new information about flares and quiescent phenomena.
In this work  analyse a solar flare occurred on February 28, 2022
classified as B5.5 in soft X-rays by GOES. Regardeless of its weak magnitude
the AR30T telescope installed at OAFA, was able to detect it. We conduct a
multiwavelength analysis comparing images and light curves from H$\alpha$,
UV, X-rays and $\mu$-waves.}
