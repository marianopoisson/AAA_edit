...
\title{Nuevos diagramas diagnósticos de edad y metalicidad 
}
...
\author{R. Butrón\inst{1} \& A.E. Piatti\inst{2}
}
...
\abstract{El estudio de la distribución espacial de las metalicidades en las 
galaxias es de fundamental importancia para reconstruir sus historias de formación 
y evolución  química. En este trabajo presentamos, por primera vez, diagramas 
diagnósticos en el plano edad-metalicidad, basados en índices definidos en el sistema 
fotométrico SDSS $ugriz$. Estos diagramas diagnósticos permiten estimar edades y
metalicidades de poblaciones estelares más viejas que $\sim$ 1 Gyr, simultáneamente. 
Concretamente, encontramos que los diagramas $\delta$($r$)  versus  
($\delta$$u$ - $\delta$$r$) y $\delta$($i$)  versus  ($\delta$$u$ - $\delta$$i$),
donde $\delta$ es la diferencia en magnitud entre el $red$ $clump$ y el $turnoff$
de la secuencia principal de la población estelar considerada,  
resultaron los más sensibles a variaciones de edad y metalicidad. Los mismos serán utilizados 
para construir mapas de edad-metalicidad a través de todo el cuerpo de ambas 
Nubes de Magallanes, a partir de la base de datos del relevamietno SMASH.
}
...
\keywords{galaxies: Magellanic Clouds --- stars: abundances --- Techniques: photometric
}
...
\contact{rbutron@electrosof.com.ar} 
