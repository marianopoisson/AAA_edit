...
\title{Análisis fotométrico de una decena de cúmulos abiertos galácticos
}
...
\author{A.L. García\inst{1,2}, F.O. Simondi-Romero\inst{1,2} \& A.V. Ahumada\inst{2,3}
}
...
\abstract{
Presentamos los parámetros astrofísicos preliminares obtenidos para 10 cúmulos abiertos de nuestra Galaxia. Los resultados, tales como edad, enrojecimiento, distancia y abundancia química, fueron derivados a partir de diagramas color-magnitud realizados con datos fotométricos provenientes de la misión GAIA y del ajuste de isócronas teóricas a los mismos. Discutimos los resultados obtenidos en relación a la ubicación de los mencionados agregados y a los determinados por otros autores.
}
...
\keywords{open clusters and associations: general --- techniques: photometric --- astrometry
}
