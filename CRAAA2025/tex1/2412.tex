...
\title{Análisis y evaluación del origen de turbulencia en plasmas del MIE}
...
\author{M.F. Montero\inst{1,2,3}, C.D. Vigh\inst{4,5,6} \& P.A. Sallago\inst{1,2}
}
...
Facultad de Ciencias Astron\'omicas y Geof{\'\i}sicas, UNLP, Argentina
\and
Centro de Investigaciones Geofísicas, UNLP, Argentina
\and
...
Departamento de F{\'\i}sica, Facultad de Ciencias Exactas y Naturales, UBA, Argentina
\and
Instituto de Física Interdisciplinaria y Aplicada, UBA-CONICET, Argentina
}
...
\abstract{La presencia de turbulencia es esencial para entender la dinámica de diferentes objetos astrofísicos, como así también el origen y evolución de los campos magnéticos que se observan. Se sabe que la explosión de supernovas, los vientos estelares y las ondas magnetohidrodinámicas son consideradas como mecanismos que eventualmente generan y sostienen la turbulencia en el medio interestelar, sin embargo existen otras posibles fuentes como pueden ser las inestabilidades en plasmas. En este contexto los efectos físicos que intervienen son diversos: fuerzas resistivas, fuerzas viscosas, campos de radiación y campos magnéticos, entre otros.  
Por estas razones, en este trabajo analizamos cada contribución relativa en las ecuaciones de la magnetohidrodinámica (MHD), considerando por separado la difusión Hall, la difusión de Ohm y la difusión ambipolar, evaluando su importancia relativa en dos escenarios distintos: {\it cold neutral medium} (CNM) y {\it warm neutral medium} (WNM).  A partir de este análisis se determinó un criterio sobre cuáles regiones pueden satisfacer las condiciones propicias para que se desarrolle la turbulencia.
}
...
\keywords{ISM:general --- MHD --- Instabilities:MRI --- Turbulence
}
...
\contact{cvigh@campus.ungs.edu.ar} 
