...
\title{Supercritical disks in pseudo-Newtonian potentials
}
...
\abstract{In this work, I develop a hydrodynamic model of super-Eddington accretion disks around black holes (BHs) using pseudo-Newtonian potentials. Pseudo-potentials, such as those of Paczyński–Wiita (for Schwarzschild BHs) and Artemova et al. (for Kerr BHs), mimic relativistic effects near the event horizon of the BH without using full general relativity (GR). Starting with a one-dimensional system of radial structure equations, I numerically solve the system under initial conditions that are consistent with supercritical regimes. I then apply self-similar solutions and compare the evolution of key quantities, such as radial and rotational velocities, disk thickness, and effective temperature. The results show that the differences between the gravitational treatments become significant near the BH. There, pseudo-Newtonian potentials offer a more accurate description of the flow’s dynamics and geometry, without the need for a full GR treatment.
}
