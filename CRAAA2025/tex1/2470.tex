...
\title{Caracterización física y dinámica de planetas hicéanos
}
...
\author{M.D. Lo Grasso\inst{1}, P.S. Zain\inst{2} \& M.N. Gómez\inst{3}
}
...
\abstract{
En esta contribución presentamos un análisis dinámico, de las propiedades físicas de las estrellas anfitrionas y de los propios planetas de una docena de planetas candidatos a ‘’Hycean’’ (planetas relativamente pequeños, calientes, rodeados de profundos océanos y una capa de hidrógeno) los cuales podrían albergar vida. Se estudia la estabilidad de la radiación recibida por estos planetas, que usualmente se encuentra a pocos centésimas de unidad astronómica de una estrella fría de tipo espectral M. Dada la cercanía, asegurar la estabilidad del flujo estelar recibido por el planeta es crucial para que se desarrollen condiciones compatibles con la existencia de vida. Se consideran algunas propiedades planetarias, como temperatura, presión y composición química atmosféricas. Por otro lado, el análisis dinámico se realiza a partir del estudio de la formación del paradigmático sistema K2-18b a partir de simulaciones de N-cuerpos desarrolladas con el código MERCURY, asumiendo distintos modelos de disco protoplanetario.
}
...
\keywords{planets and satellites: dynamical evolution and stability --- planets and satellites: atmospheres --- protoplanetary disks
}
...
\contact{matiaslograsso@outlook.com} 
