...
\title{Determinaci\'on de par\'ametros astrof\'isicos de c\'umulos abiertos de peque\~no di\'ametro angular con fotometr\'ia de GAIA
}
...
\author{B.N. Arnijas\inst{1,2}, J.F. Bustillos-Rava\inst{1,2}, F.M. Caporaso\inst{1,2}, I. Gamboa\inst{1,2}, A.A Medina\inst{1,2},\\ J.M. Puddu\inst{1,2}, R. Quarin\inst{1,2}, V.R. Sandez\inst{1,2}, C.M. Segovia\inst{1,2}, M. Tetzlaff\inst{1,2},\\ F.O. Simondi-Romero\inst{1,2}, A.V. Ahumada\inst{2,3}, J. Rapoport\inst{1,2} \& C.G. Bornancini\inst{2,3,4}
}
...
\keywords{(Galaxy:) open clusters and associations: general; (Galaxy:) globular clusters: general --- techniques: photometric
}
