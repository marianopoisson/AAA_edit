...
\title{Caracterización de cúmulos abiertos con fotometría de CASLEO y Gaia}
...
\author{T.I. Macaroff\inst{1,2}, M.T. Krilich\inst{1,2}, J.C. Rapoport\inst{1,2} \& F.O. Simondi-Romero\inst{1,2}
}
...
Los cúmulos abiertos son laboratorios naturales para estudiar la evolución estelar, ya que agrupan estrellas con edades y composiciones similares. Una caracterización precisa de sus parámetros fundamentales permite mejorar los modelos de evolución estelar. En este trabajo analizamos tres cúmulos abiertos combinando fotometría de CASLEO y datos de {\it Gaia}. A partir de los diagramas color-magnitud construidos, ajustamos isócronas teóricas para estimar edad, distancia y extinción de cada cúmulo. Este enfoque combinado mejora la precisión en la caracterización estelar y aporta información relevante sobre su evolución.
}
...
\keywords{(Galaxy:) open clusters and associations: general --- (Galaxy:) open clusters and associations: individual (Danks 1, Danks 2, NGC 3105) --- techniques: photometric
}
