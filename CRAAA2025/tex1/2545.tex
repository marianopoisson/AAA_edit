...
\title{An\'alisis de la emisi\'on de continuo a 1420~MHz en el segundo 
\\cuadrante gal\'actico}
...
\author{S.B. Cárdenas\inst{1,2}, S. Cichowolski\inst{1} \& R. Gamen\inst{3}
}
...
\keywords{ISM: general --- (ISM:) HII regions --- stars: massive
}
