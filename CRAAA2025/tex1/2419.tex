...
\abstract{
La clasificación de binarias de alta masa utilizando lógica borrosa (\textit{fuzzy logic}) con \textit{hold out} automático permite manejar la incertidumbre y ambigüedad en los datos.
En este trabajo se propone un enfoque para clasificar sistemas binarios de alta masa utilizando lógica borrosa con \textit{hold} automático.
