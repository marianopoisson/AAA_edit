...
\title{Estudio de cúmulos abiertos posiblemente relacionados}
...
\author{E.E. Giorgi\inst{1,2} , M.A. De Laurenti\inst{3},  M.M. Leiva\inst{1},  G.I. Perren\inst{4.5}      
\&   R.A. Vázquez\inst{1}  
}
...
\and
Instituto de Astrofísica de La Plata, CONICET-UNLP, 1900 La Plata, Argentina,
\and
Observatorio Astronómico Municipal "Ing. Angel Di Palma", Mercedes (Bs.As.), Argentina,
\and
Facultad de Ciencias Exactas, Ingeniería y Agrimensura, UNR, Rosario, Argentina,
\and
Facultad de Ciencias Exactas, Ingeniería y Agrimensura, UNR, Rosario, Argentina
\and
Instituto de Física de Rosario, CONICET-UNR, Rosario, Argentina
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\abstract{
En los últimos años se ha incrementado la cantidad de cúmulos abiertos detectados y catalogados en la Vía Láctea. Algunos de estos cúmulos se encuentran en posiciones muy próximas entre sí, y esto ha sugerido que podrían estar también relacionados físicamente. En este trabajo se utilizan datos  provenientes de $Gaia$ DR3 en combinación con observaciones fotométricas $UBVI$ de algunas regiones para analizar casos en donde los cúmulos podrían estar relacionados y formar parte de  sistemas binarios o múltiples.
}
...
%                                                                            %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\keywords{(Galaxy:) open clusters and associations: general  -- techniques: photometric}
